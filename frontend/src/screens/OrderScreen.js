        ...
        <Col md={8}>
          <ListGroup variant="flush">
            <ListGroup.Item>
              ...
              <p>
              <h3>Business-to-consumer market : </h3><br></br>
A business-to-consumer market involves businesses advertising products directly to customers for purchase. The business-to-consumer market is usually identified as the biggest type of business market, as it caters to the largest group of potential consumers. This is because companies that use a business-to-consumer market design their efforts considering the general public or specific demographics that exist within the population, such as different age groups, genders or groups with special interests.
<br></br>
<h3>Business-to-business market :</h3> <br></br>
Companies that use business-to-business markets advertise and sell their goods or services to other businesses instead of marketing directly to consumers. Products and services sold in a business-to-business market are often reused or resold by the company that purchases them and sometimes function as materials for manufacturing new products. Some companies that operate in a business-to-business market might also sell to consumers, but most focus on selling their products or services to other companies and businesses.
            ...
            <ListGroup.Item>
              <h2>Employess worked In Project</h2>

              {order.orderItems.length === 0 ? (
                <Message variant="info">{order.User.name}</Message>
              ) : (
                <ListGroup variant="flush">
